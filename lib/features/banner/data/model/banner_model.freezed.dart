...
abstract class $BannerModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, DateTime? createdAt, String? image});
}
...
class _$BannerModelImpl implements _BannerModel {
  _$BannerModelImpl({this.id, this.createdAt, this.image});
  ...
  @override
  String toString() {
    return 'BannerModel(id: $id, createdAt: $createdAt, image: $image)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, createdAt, image);
